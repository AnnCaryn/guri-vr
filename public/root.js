...
/***/ function(module, exports, __webpack_require__) {
	...
	var _StoryList = __webpack_require__(85);

	var _StoryList2 = _interopRequireDefault(_StoryList);

	var _StoryEditor = __webpack_require__(89);

	var _StoryEditor2 = _interopRequireDefault(_StoryEditor);

	var _Guide = __webpack_require__(90);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _nlp = __webpack_require__(79);
...
/***/ function(module, exports) {
	...
	function getObjects(p) {
	  ...
	  return objects.map(function (obj, i) {
	    ...
	    var sp = i !== 0 ? p.substring(objects[i - 1].index + objects[i - 1].type.length, objects[i].index + objects[i].type.length + 1) : p.substring(0, objects[i].index + objects[i].type.length + 1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Fab = __webpack_require__(88);
	...
	var StoryList = function (_Component) {
	  ...
	  _createClass(StoryList, [{
	    ...
	    value: function onShare(id) {
	      open(_config.assetsHost + '/s/' + id + '.html', '_blank');
	    }
	  }, {
	    key: 'onEdit',
	    ...
	    value: function renderLoader() {
	      return (0, _preact.h)(_preactMdl.Spinner, { 'is-active': true, 'single-color': true, style: styles.spinner });
	    }
	  }, {
	    key: 'render',
...
/***/ function(module, exports) {
	...
	module.exports = {
		"assetsHost": "https://s3.amazonaws.com/gurivr"
	};
	...
	var StoryEditor = function (_Component) {
	  ...
	  _createClass(StoryEditor, [{
	    ...
	    value: function onShare() {
	      ...
	      open(_config.assetsHost + '/s/' + _id + '.html', '_blank');
	    }
	  }, {
	    key: 'render',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CodeExample = __webpack_require__(91);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (_ref) {
	  ...
	  return (0, _preact.h)(
	    ...
	    (0, _preact.h)(
	      'a',
	      { href: '/api/preview?title=' + title + '&body=' + encodeURIComponent(JSON.stringify((0, _nlp2.default)(text))), target: '_blank', style: styles.run },
	      'Run the story'
	    )
	  );
	};
